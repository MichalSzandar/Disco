...
public class Tile implements Runnable {
    ...
    public void stopThread() {
     ...
     /**
     * Constructs a Tile object with specified parameters.
    ...
    /**
     * pauses and resumes tile's thread when user clicks on it. Synchronized to puaseLockObject.
     */
    ...
    /**
     * returns colors of tile's neighbours which are not paused.
    ...
    public ArrayList<Color> getNeighboursColors() {
     ...
     /**
     * Calculates the average color of the neighboring tiles.
    ...
    /**
     * Repaints the tile with the specified color.
    ...
    /**
     * The run method to be executed in a separate thread, controlling the tile's behavior.
     */
    @Override
    public void run() {
        while (running) {
